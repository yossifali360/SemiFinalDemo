...
function returnProductData(data){
    ...
    if (data.discount){
        ...
        <div class = "d-flex flex-lg-row flex-column bg-white rounded-2 w-100 p-4 ProductCtn align-items-stretch justify-content-between">
            ...
            <div class = "right w-50 p-3">
                <div class="h-100 d-flex flex-column justify-content-between productCard" data-id="${data.id}" data-stock="${data.stock}" data-discount="${data.discount}">
    ...
    <div class = "d-flex flex-lg-row flex-column bg-white rounded-2 w-100 p-4 ProductCtn align-items-stretch justify-content-between">
        ...
        <div class = "right w-50 p-3">
            <div class="h-100 d-flex flex-column justify-content-between productCard" data-id="${data.id}" data-stock="${data.stock}">
                <h2 class = "product-name d-block">${data.title}</h2>
